    ...
    <div class="content-header-left col-md-12 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                ...
                <div class="float-end">
                    @can('dealer-add')
                        <a href="{{ route('admin.dealer.create') }}" class="btn btn-icon btn-primary waves-effect"
                        ...
                        @foreach ($dataProvider as $key => $data)
                            <tr>
                                ...
                                <td class="text-center">
                                    @can('dealer-change-status')
                                        <button class="btn btn-icon btn-outline-success btn-status waves-effect"
                                            data-action="{{ route('admin.dealer.change-status', $data->uuid) }}"
                                ...
                                <td>
                                    @can('dealer-edit')
                                        <a href="{{ route('admin.dealer.edit', $data->uuid) }}"
                                    ...
                                    @can('dealer-delete')
                                        <button class="btn btn-icon btn-outline-danger btn-delete waves-effect"
                                            data-action="{{ route('admin.dealer.destroy', $data->uuid) }}"
