    ...
    <div class="content-header-left col-md-12 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                ...
                <div class="float-end">
                    @can('attribute-add')
                        <a href="{{ route('admin.attribute.create') }}" class="btn btn-icon btn-primary waves-effect"
                        ...
                        @foreach ($dataProvider as $key => $data)
                            <tr>
                                ...
                                <td class="text-center">
                                    @can('attribute-change-status')
                                        <button class="btn btn-icon btn-outline-success btn-status waves-effect"
                                            data-action="{{ route('admin.attribute.change-status', $data->uuid) }}"
                            ...
                            <td>
                                @can('attribute-edit')
                                    <a href="{{ route('admin.attribute.edit', $data->uuid) }}"
                                ...
                                @can('attribute-delete')
                                    <button class="btn btn-icon btn-outline-danger btn-delete waves-effect"
                                        data-action="{{ route('admin.attribute.destroy', $data->uuid) }}"
