    ...
    <div class="content-header-left col-md-12 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                ...
                <div class="float-end">
                    @can('agent-add')
                        <a href="{{ route('admin.agent.create') }}" class="btn btn-icon btn-primary waves-effect"
                        ...
                        @foreach ($dataProvider as $key => $data)
                            <tr>
                                ...
                                <td class="text-center">
                                    @can('agent-change-status')
                                        <button class="btn btn-icon btn-outline-success btn-status waves-effect"
                                            data-action="{{ route('admin.agent.change-status', $data->uuid) }}"
                                ...
                                <td>
                                    @can('user-add')
                                        <a href="{{ route('admin.user.index', ['agent' => $data->uuid]) }}"
                                            class="btn btn-icon btn-outline-info waves-effect" data-bs-toggle="tooltip"
                                            data-bs-original-title="Users"><i data-feather='user'></i></a>
                                    @endcan
                                    @can('agent-edit')
                                        <a href="{{ route('admin.agent.edit', $data->uuid) }}"
                                    ...
                                    @can('agent-delete')
                                        <button class="btn btn-icon btn-outline-danger btn-delete waves-effect"
                                            data-action="{{ route('admin.agent.destroy', $data->uuid) }}"
