...
@section('content')
    ...
    <form action="{{ route('admin.agent.store') }}" method="post" id="form" class="form needs-validation" novalidate
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        <div class="mb-1">
                            <label for="" class="form-label">Agent <span class="text-danger">*</span></label>
