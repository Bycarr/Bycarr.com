...
@section('breadcrumb')
    <div class="content-header-left col-md-12 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-start mb-0">{{ $menu->title }}</h2>
                ...
                <div class="float-end">
                    <a href="{{ route('admin.menu.index') }}" class="btn btn-icon btn-primary waves-effect"
                        data-bs-toggle="tooltip" data-bs-original-title="Back"><span><i
                                data-feather='rotate-ccw'></i></span></a>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="accordion" id="accordionHover" data-toggle-hover="true">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="accordionHoverTwo" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <form action="{{ route('admin.menu.menu-item.store', $menu->uuid) }}"
                                                    id="brand_form" method="post">
                                                    @csrf
                                                    <fieldset class="content-group"
                                                        style="max-height: 500px; overflow-y: scroll; overflow-x:hidden">
                                                        <input type="hidden" name="type"
                                                            value="{{ ConstantHelper::MENU_TYPE_BRAND }}" />
                                                        @if (!empty($brands))
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="customAccordion" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <form action="{{ route('admin.menu.menu-item.store', $menu->uuid) }}"
                                                    id="form" method="post" class="form needs-validation"
                                                    novalidate>
                                                    @csrf
                                                    <fieldset class="content-group"
                                                        style="max-height: 500px; overflow-y: scroll; overflow-x:hidden">
                                                        ...
                                                        <div class="mb-1">
                                                            <div class="checkbox-inline">
                                                                <label class="checkbox checkbox-lg">
                                                                    <input type="checkbox" name="link_target"
                                                                        value="1"
                                ...
                                @foreach ($items['parent'] as $lvl => $item)
                                    <li class="dd-item" data-id="{{ $item['id'] }}">
                                        <div class="dd-handle">
                                            ...
                                            <span
                                                class="float-right badge badge-flat border-info text-info text-uppercase">{{ !empty($item['type']) ? $item['type'] : 'Custom' }}</span>
                                        </div>
