            ...
            <div class="col-12">
                ...
                <div class="float-end">
                    @can('product-model-add')
                        <a href="javascript:void(0)" data-bs-target="#brandModal" data-bs-toggle="modal">
                        ...
                        @foreach ($dataProvider as $key => $data)
                            <tr>
                                ...
                                <td class="text-center">
                                    @can('product-brand-change-status')
                                        <button class="btn btn-icon btn-outline-success btn-status waves-effect"
                                            data-action="{{ route('admin.product-brand.change-status', $data->uuid) }}"
                            ...
                            <td>
                                @can('product-brand-edit')
                                    <a href="{{ route('admin.product-brand.model.index', $data->uuid) }}"
                                        class="btn btn-icon btn-outline-primary waves-effect" data-bs-toggle="tooltip"
                                        data-bs-original-title="Models"><i data-feather='list'></i></a>
                                    <a class="edit-brand" href="javascript:void(0)" data-bs-target="#brandModal"
                                ...
                                @can('product-brand-delete')
                                    <button class="btn btn-icon btn-outline-danger btn-delete waves-effect"
                                        data-action="{{ route('admin.product-brand.destroy', $data->uuid) }}"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body px-5 pb-5">
                <div class="text-center mb-4">
                    <h3 class="role-title">Add/Update Brand</h3>
                </div>
                <!-- Add role form -->
                <form class="row" action="{{ route('admin.product-brand.store') }}" method="POST"
                    ...
                    <div class="mb-1">
                        ...
                        <input type="text" id="title" name="title" class="form-control"
                            placeholder="Enter brand title" tabindex="-1" data-msg="Please enter category title"
                            required />
                    </div>
                    <div class="mb-1">
