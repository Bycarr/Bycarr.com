    ...
    <div class="content-header-left col-md-12 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                ...
                <div class="float-end">
                    @can('content-add')
                        <a href="{{ route('admin.content.create') }}" class="btn btn-icon btn-primary waves-effect"
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        @foreach ($dataProvider as $key => $data)
                            ...
                            <td>
                                @can('content-edit')
                                    <a href="{{ route('admin.content.edit', $data->uuid) }}"
                                ...
                                @can('content-delete')
                                    <button class="btn btn-icon btn-outline-danger btn-delete waves-effect"
                                        data-action="{{ route('admin.content.destroy', $data->uuid) }}"
