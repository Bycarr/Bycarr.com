    ...
    <div class="content-header-left col-md-12 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                ...
                <div class="float-end">
                    @can('banner-add')
                        <a href="{{ route('admin.banner.create') }}" class="btn btn-icon btn-primary waves-effect"
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        @foreach ($dataProvider as $key => $data)
                            ...
                            <td>
                                @can('banner-edit')
                                    <a href="{{ route('admin.banner.edit', $data->uuid) }}"
                                ...
                                @can('banner-delete')
                                    <button class="btn btn-icon btn-outline-danger btn-delete waves-effect"
                                        data-action="{{ route('admin.banner.destroy', $data->uuid) }}"
