    ...
    <div class="content-header-left col-md-12 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                ...
                <div class="float-end">
                    @can('menu-add')
                        <a href="{{ route('admin.menu.create') }}" class="btn btn-icon btn-primary waves-effect"
                            ...
                            <td>
                                @can('menu-item')
                                    <a href="{{ route('admin.menu.menu-item.index', ['menu' => $data->uuid]) }}"
                                        ...
                                        data-bs-original-title="Menu Items"><i data-feather='list'></i></a>
                                @endcan
                                @can('menu-edit')
                                    <a href="{{ route('admin.menu.edit', $data->uuid) }}"
                                ...
                                @can('menu-delete')
                                    <button class="btn btn-icon btn-outline-danger btn-delete waves-effect"
                                        data-action="{{ route('admin.menu.destroy', $data->uuid) }}"
